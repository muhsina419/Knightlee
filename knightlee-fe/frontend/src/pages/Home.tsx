...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#E9FFF7] to-[#CCF5E9]">

      {/* 🔹 Navbar stays on top, not affecting layout */}
      <Navbar />

      {/* 🔹 Main home content — stays centered like before */}
      <div className="flex flex-col items-center px-6 pb-10">

        {/* Logo */}
        <div className="w-24 h-24 bg-[#08a870] rounded-3xl flex items-center justify-center shadow-lg mt-10">
          <svg
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16 max-w-6xl w-full">
          ...
          {/* 1. Helpline */}
          <a href="/helpline" className="bg-white rounded-3xl shadow-md p-6 hover:shadow-lg transition block cursor-pointer">
          ...
          {/* 2. Safe Points */}
          <a href="/safepoints" className="bg-white rounded-3xl shadow-md p-6 hover:shadow-lg transition block cursor-pointer">
          ...
          {/* 3. Emergency SOS */}
          <a href="/sos" className="bg-white rounded-3xl shadow-md p-6 hover:shadow-lg transition block cursor-pointer">
